...
class AuthorController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($author)
            -> add('name', TextType::class, array('attr' => array('class' => 'form-control', 'style' => 'margin-bottom:15px'), 'label' => 'Imię'))
            -> add('surname', TextType::class, array('attr' => array('class' => 'form-control', 'style' => 'margin-bottom:15px'), 'label' => 'Nazwisko'))
            -> getForm();
